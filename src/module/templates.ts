export default function ():Promise<void> {
  const templatePaths = [
    ...
    "systems/twodsix/templates/actors/parts/items/actor-equipped.html",
    "systems/twodsix/templates/actors/parts/items/actor-storage.html",
    "systems/twodsix/templates/actors/parts/items/actor-finances.html",
