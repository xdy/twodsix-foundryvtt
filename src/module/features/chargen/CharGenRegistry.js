 ...
 * @property {string|null} [careerPackId] - Career compendium (defaults to itemPackId)
 * @property {string|null} [careerPackFallbackId]
 * @property {string|null} [traitPackId] - Trait compendium (defaults to itemPackId)
 * @property {string|null} [traitPackFallbackId]
 * @property {string|null} [speciesPackId] - Species compendium (defaults to itemPackId)
 * @property {string|null} [speciesPackFallbackId]
 */

/**
 * @typedef {Object} SpeciesCharCaps
 * @property {number} min - Minimum characteristic value
 * @property {number} max - Maximum characteristic value (use `Infinity` to disable)
 */
 ...
 * @property {SpeciesCharCaps} [speciesCharCaps] - Per-ruleset characteristic min/max caps
...
export const CHARGEN_REGISTRY = {
  CE: {
    ...
    packs: {
      ...
      traitPackId: 'twodsix.ce-srd-items',
    },
  ...
  CDEE: {
    ...
    packs: {
      ...
      itemPackFallbackId: 'twodsix.cepheus-deluxe-items',
      traitPackId: 'twodsix.cepheus-deluxe-enhanced-edition-items',
    },
  ...
  SOC: {
    ...
    packs: {
      ...
      itemPackFallbackId: 'twodsix.ce-srd-items',
      traitPackId: 'twodsix.sword-of-cepheus-items',
    },
 ...
 */
function mergeCharGenRegistryEntry(partial) {
  const defaults = {
    needsPreload: true,
    displayName: '',
    packs: {
      itemPackId: null,
      itemPackFallbackId: null,
      careerPackId: null,
      careerPackFallbackId: null,
      traitPackId: null,
      traitPackFallbackId: null,
      speciesPackId: null,
...
export function registerChargenRuleset(key, entry) {
  ...
  CHARGEN_REGISTRY[canonicalKey] = mergeCharGenRegistryEntry(entry);
  refreshChargenSupportedRuleSets();
}
