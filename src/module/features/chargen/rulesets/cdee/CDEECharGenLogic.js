...
export class CDEECharGenLogic extends BaseCharGenLogic {
  resetData() {
    ...
    this.traitPackNames = ['twodsix.cepheus-deluxe-enhanced-edition-items'];
  }
  ...
  _getCareerPackOptions(ruleset) {
    return {
      careersPackName: 'twodsix.cepheus-deluxe-enhanced-edition-items',
    };
  }
  ...
  _assignRulesetConstants(careers, careerNames, ruleset) {
    ...
    // ensure base CDEE items are also checked if not already there
    if (!this.traitPackNames.includes('twodsix.cepheus-deluxe-enhanced-edition-items')) {
      this.traitPackNames.push('twodsix.cepheus-deluxe-enhanced-edition-items');
    }
  }
