...
//  */
//
// //TODO Extracted this from earlier version when I intended to base the character around the UCF. Some possibly useful code for the UCF when that gets done.
//
//
