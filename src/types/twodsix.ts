...
import _TwodsixItem from "../module/entities/TwodsixItem";
import _TwodsixActor from "../module/entities/TwodsixActor";
import {rollItemMacro} from "../module/utils/rollItemMacro";
import {TwodsixItemSheet} from "../module/sheets/TwodsixItemSheet";
import type {ActorTwodsixDataSource, ItemTwodsixDataSource, ShipAction} from "./template";
...
declare global {
  ...
  namespace ClientSettings {
    interface Values {
      ...
      'twodsix.useMaxArmorValue':boolean;
...
declare global {
  interface TwodsixShipSheetSettings {
  ...
  interface TwodsixVehicleSheetSettings {
    showHullAndArmor:string;
  }

  interface TwodsixSpaceObjectSheetSettings {
    useProseMirror?:boolean;
  }
  ...
  interface ExtraData {
    ...
    positionName?:string;
    diceModifier?:string;
    component?:_TwodsixItem;
  }

  interface AvailableShipActionData {
  ...
  interface TwodsixItemSheetData {
  ...
  interface TwodsixShipPositionSheetData {
  ...
  interface Game {
    twodsix:{
      ...
      config:TWODSIX
      entities:{
        TwodsixActor:typeof _TwodsixActor;
        TwodsixItem:typeof _TwodsixItem;
      };
      macros:{
    ...
    CONFIG:{
      TWODSIX:TWODSIX;
      Actor:{
        documentClass:typeof _TwodsixActor;
        sheetClasses:{
          traveller:{
      ...
      Item:{
        documentClass:typeof _TwodsixItem;
        sheetClasses:{
