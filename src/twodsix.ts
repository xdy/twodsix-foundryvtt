...
Hooks.once('init', async function () {
  ...
  const equippableItems = ["equipment", "weapon", "armor", "augment", "storage", "tool", "junk", "skills", "spell", "trait", "consumable", "component", "computer", "psiAbility"];
  foundry.documents.collections.Items.registerSheet("twodsix", TwodsixItemSheet, {types: equippableItems, makeDefault: true, label: "TWODSIX.SheetTypes.ItemSheet"});
