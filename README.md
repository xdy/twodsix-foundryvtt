...
* The icon static/assets/pause/Imperial-Sunburst-Sun-Scouts-wiki.svg folder is based on  https://wiki.travellerrpg.com/File:Imperial-Sunburst-Sun-Scouts-wiki.png which is made by [Thomas Jones-Low](https://wiki.travellerrpg.com/Thomas_Jones-Low) which was provided under the terms of the [CC-By-SA](https://creativecommons.org/licenses/by-nc/3.0/) license.
